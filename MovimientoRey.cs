...
namespace PosicionDelReyAjedrez
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] coordenada = coordenadas.Split(' ');//En un array capturamos ambos datos ya que uno es un número y otro una letra
                                                //  ^^ esta parte hace de separador entre dos variables, puede reemplazarse por
                                                //cualquier otro caracter para separar las dos variables capturadas, o más
                    ...
                    switch (opcion)
                    {
                        ...
                        case 1:
                            if (posiv <= 8)
                            {
                                ...
                                Console.Write("R");//Para una notación correcta se escribe la letra que representa la pieza y la coordenada
                                                   //Como es el rey es; Ra1, por ejemplo
                                Console.Write(posiH);
